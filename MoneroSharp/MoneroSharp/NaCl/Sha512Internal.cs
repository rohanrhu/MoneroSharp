...
namespace MoneroSharp.NaCl.Internal
{
    public static class Sha512Internal
    {
        ...
        public static void Sha512Init(out Array8<ulong> state)
        {
        ...
        public static void Core(out Array8<ulong> outputState, ref Array8<ulong> inputState, ref Array16<ulong> input)
        {
            unchecked
            {
                var a = inputState.x0;
